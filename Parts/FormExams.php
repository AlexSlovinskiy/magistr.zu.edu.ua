						<div class="contactform">
            				...
            				<?$type=1;?>
              				<fieldset>
              					<legend>&nbsp;���������� �������� ����Ҳ�&nbsp;</legend>
											<p>
											<label for="exam_name1" class="small" style="margin-left:79px">���� �� ����� � ����������� ��������: </label>
		                                   	...
		                                   	<?if ($cross_enter == '-') {echo " x2"; $type = 2;}?>
                                			</p>
											<p>
                     						<label for="exam_name2" class="small" >���� �� ����� � �������� ���� (��� �����������): </label>
                                			...
                                			<p>
                     						<label for="exam_name3" class="small" style="margin-left:21px">���� �� ���������� ����� (����������� �����): </label>
		                                   	<input type="text" name="exam_mark3" id="exam_mark3" class="field"
		                                   	value="<?if ($_POST['exam_mark3']>0) echo $_POST['exam_mark3']; else echo "";?>"
											<? if ($cross_enter == '-') echo "disabled"; ?>
		                                   	tabindex="20" maxlength="6" style="width:50px; text-align:center"/>
                                			</p>
                                			<p><label for="dip_average" class="small" style="margin-left:184px">������� ��� �������:</label>
                                			...
                                			<p><label for="final_mark" class="small" style="margin-left:166px">�������� ������� ����:</label>
							...
							<p>	<input type="submit" name="set_exams" id="submit" class="button" value="��������" tabindex="60" /></p>
                			</fieldset>
              				</form>
				    	</div>
