						<ul>
            				...
            				<span style="color:rgb(80,80,80); font-weight:bold;">Додати напрям підготовки: </span>
            				</li>
            			</ul>
						<div class="contactform" style="margin-top:5px; margin-bottom:15px;">
							<form method="post" action="<?$_SERVER["SCRIPT_NAME"]?>">

                                <p><label for="training" class="left">Новий напрям:</label>
                        ...
                        <ul>
            				<li style="display:inline;">
            				<span style="color:rgb(80,80,80); font-weight:bold;">Редагувати напрям: </span>
            				</li>
            			</ul>
						...
						<div class="contactform" style="margin-top:5px; margin-bottom:15px;">
							<form method="post" action="<?$_SERVER["SCRIPT_NAME"]?>">
                                <p><label for="edit_training" class="left">Напрям:</label>
                                ...
                                <p><label for="new_training" class="left">Нова назва напряму:</label>
                        ...
                        <ul>
            				<li style="display:inline;">
            				<span style="color:rgb(80,80,80); font-weight:bold;">Видалити напрям: </span>
            				</li>
            			</ul>
						<div class="contactform" style="margin-top:5px; margin-bottom:15px;">
							<form method="post" action="<?$_SERVER["SCRIPT_NAME"]?>">
								<p><label for="del_training" class="left">Напрям:</label>
