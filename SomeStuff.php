...
<body>
	<div class="main-content" style="width:100%">
    	<h1 class="pagetitle" style="margin-top:1em; margin-right:50px;"> Шось таке</h1>
			<div class="printBtn">
				<form>
					<p>
		...
		<table align=center width="900px" class="examsblank" cellspacing=0 cellpadding=0 border=0>
			...
			<tr style="font-family:times;font-size:18px;">
				<td style="border:none; padding-bottom:10px;" align=center><strong>СПИСОК</strong></td>
			</tr>
			<tr style="font-family:times;font-size:18px;">
				<td style="border:none; padding-bottom:15px;" align=center><strong>Хто куди вступив...</strong></td>
			</tr>
			<tr>
				<table align=center width="1000px" class="exams" cellspacing=0 cellpadding=0 border=1 style="border:solid 2px rgb(0,0,0);">
					<tr>
                    	 ...
                    	 <td align=center>Форма нав-ня <br />фінансування</td>
					...
					<tr>
                    	<td align=center colspan="11"><strong>Денна форма навчання (бакалавр)</strong></td>
                    </tr>
					<?php
                            $j=1; $k=1;							$query="SELECT * FROM abiturients
											WHERE
											qualification = 'Бакалавр' AND
											dip_study_type = 'Денна' AND
											dip_finans = 'Бюджет' AND
											take_away = '-' AND
											recommend = '+' AND
											pact <> '-'
							...
							if (mysql_num_rows($sql)>0)
								{								echo "<tr><td align=center colspan='11'><b>Бюджет</b></td></tr>";
								while ($row = mysql_fetch_assoc($sql))
                                    ...
                                    if ($row["finans"]=="b") echo "Бюджет</td>";
                                    if ($row["finans"]=="c") echo "Контракт</td>";
							...
							if (mysql_num_rows($sql)>0)
								{
								echo "<tr><td align=center colspan='11'><b>Контракт</b></td></tr>";
								while ($row = mysql_fetch_assoc($sql))
									{
                                    echo "<tr><td align=center>".$j.".</td><td align=center>".$k.".</td>";
                                    echo "<td align=left>".$row["lastname"]." ".$row["firstname"]." ".$row["patronymic"]."</td>";
					...
					?>
                    <tr>
                    	<td align=center colspan="11"><strong>Денна форма навчання (спеціаліст)</strong></td>
                    </tr>
					<?php

							$query="SELECT * FROM abiturients
											WHERE
											qualification = 'Спеціаліст' AND
											dip_study_type = 'Денна' AND
											dip_finans = 'Бюджет' AND
											take_away = '-' AND
											recommend = '+' AND
							...
							if (mysql_num_rows($sql)>0)
								{
								echo "<tr><td align=center colspan='11'><b>Контракт</b></td>";
								while ($row = mysql_fetch_assoc($sql))
									{
                                    echo "<tr><td align=center>".$j.".</td><td align=center>".$k.".</td>";
                                    echo "<td align=left>".$row["lastname"]." ".$row["firstname"]." ".$row["patronymic"]."</td>";
					...
					<tr>
                    	<td align=center colspan="11"><strong>Заочна форма навчання (бакалавр)</strong></td>
                    </tr>
					<?php
					...
					<tr>
                    	<td align=center colspan="11"><strong>Заочна форма навчання (Спеціаліст)</strong></td>
                    </tr>
					<?php
